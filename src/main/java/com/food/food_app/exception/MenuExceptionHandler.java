...
public class MenuExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponceStructure<String>> MenuNotFoundException(MenuNotFoundException exception) {
		ResponceStructure<String> structure = new ResponceStructure<String>();
		structure.setMessage("Menu with id:" + exception.id +" is not available");
		structure.setStatus(HttpStatus.NOT_FOUND.value());
		structure.setT("Menu not found");
