...
public class EmailExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponceStructure<String>> EmailNotFoundException(EmailNotFoundException exception) {
		ResponceStructure<String> structure = new ResponceStructure<String>();
		structure.setMessage("User with email:" + exception.email +" does not exist.");
